...
const SideBar = () => {
  ...
  useEffect(() => {
    if (isMobile && sidebarOpened) {
      setBarClass('sideContainer isMobile opened');
    } else if (isMobile && !sidebarOpened) {
      setBarClass('sideContainer isMobile');
    } else {
      ...
      {sidebarOpened && (
        <div className={barClass}>
          <ul>
            ...
            {user && user.role && user.role === 'super' && (
              <Link onClick={onclick} to="/register">
                ...
                >
                  ...
                  >
                    <path
                      d="M19.8057 5.01122L20 5C20.8547 5 21.5592 5.6434 21.6555 6.4723L21.6667 6.66667V18.3333H33.3333C34.188 18.3333 34.8925 18.9767 34.9888 19.8057L35 20C35 20.8547 34.3567 21.5592 33.5277 21.6555L33.3333 21.6667H21.6667V33.3333C21.6667 34.188 21.0233 34.8925 20.1943 34.9888L20 35C19.1453 35 18.4408 34.3567 18.3445 33.5277L18.3333 33.3333V21.6667H6.66667C5.81193 21.6667 5.10748 21.0233 5.01122 20.1943L5 20C5 19.1453 5.6434 18.4408 6.4723 18.3445L6.66667 18.3333H18.3333V6.66667C18.3333 5.81193 18.9767 5.10748 19.8057 5.01122L20 5L19.8057 5.01122Z"
                      fill="#14279B"
                    />
                  </svg>
                  Register
            ...
            {user && user.role && user.role === 'super' && (
              <Link onClick={onclick} to="/MarksheetGeneration">
                <li className={location.pathname === '/MarksheetGeneration' ? 'active' : ''}>
            ...
            <Link aria-current="page" onClick={onclick} to="/Attendence">
              <li
                className={location.pathname === '/Attendence' ? 'active' : ''}
              >
                <svg
                  width="40"
                  height="40"
